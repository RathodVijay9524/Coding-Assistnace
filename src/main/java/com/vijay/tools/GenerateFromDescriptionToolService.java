...
public class GenerateFromDescriptionToolService implements AiToolProvider {
    ...
    public String generateProject(
        ...
        try {
            ...
            String project = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();
    ...
    public String generateModule(
        ...
        try {
            ...
            String module = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();
    ...
    public String generateMicroservice(
        ...
        try {
            ...
            String microservice = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();
    ...
    public String generateTestSuite(
        ...
        try {
            ...
            String testSuite = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();
    ...
    public String generateProjectDocumentation(
        ...
        try {
            ...
            String documentation = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();

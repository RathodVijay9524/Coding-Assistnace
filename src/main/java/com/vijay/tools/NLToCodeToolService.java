...
public class NLToCodeToolService implements AiToolProvider {
    ...
    public String nlToCode(
        ...
        try {
            ...
            String code = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();
    ...
    public String generateFunction(
        ...
        try {
            ...
            String function = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();
    ...
    public String generateClass(
        ...
        try {
            ...
            String classCode = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();
    ...
    public String generateAlgorithm(
        ...
        try {
            ...
            String algorithm = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();
    ...
    public String generateApiEndpoint(
        ...
        try {
            ...
            String endpoint = chatClientProvider.getObject().prompt()
                .user(prompt)
                .call()
                .content();
